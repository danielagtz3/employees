...
class Employee(ABC):
    ...
    def interact(self, other):
        ...
        rel_value = self.relationships[other.name]
        
        if rel_value > RELATIONSHIP_THRESHOLD:
            self.happiness += 1
...
class TemporaryEmployee(Employee):
    def __init__(self, name, manager, salary, savings, contract_end="2024-12-31"):
        super().__init__(name, manager, salary, savings)
...
class PermanentEmployee(Employee):
    def __init__(self, name, manager, salary, savings, hire_date="2023-01-01"):
        super().__init__(name, manager, salary, savings)
